...
<body>
	<div class="row">
		...
		<center>
			...
			<div>
				<input type="button" value="My Babby"> <input type="button"
					value="Reservation"> <input type="button" value="Wish List">
				<input type="button" value="My Board"> <input type="button"
					value="My Q&A">
			</div>
			<div>
